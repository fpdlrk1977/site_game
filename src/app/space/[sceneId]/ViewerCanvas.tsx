...
//
// ★ **걷기가 붙었다**(2026-08-05, `BRICK_PLAN.md` §6). `BrickScene` 안에 들어 있으므로
//   에디터와 뷰어가 **같은 걷기**를 쓴다. 방문자가 지어 둔 공간을 걸어 다니는 것이
//   이 제품의 원래 그림이고, 그게 이제 실제로 된다. 켜고 끄는 버튼은 `ViewerClient`에 있다.
