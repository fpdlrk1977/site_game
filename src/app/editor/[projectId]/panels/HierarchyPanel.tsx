    ...
    <>
      <div className="px-2 pt-2 pb-1 shrink-0">
        <input
          ...
          className="w-full h-7 bg-muted/5 dark:bg-muted/10 border border-border/30 rounded-xs px-2.5 text-xs text-foreground placeholder-muted focus:outline-none focus:border-primary transition-colors"
        />
      </div>
