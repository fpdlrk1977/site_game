  ...
  return (
    <aside className="w-[240px] shrink-0 h-full overflow-y-auto bg-sidebar border-r border-border flex-col p-3 hidden md:flex">
      <nav className="flex flex-col gap-0.5">
        <Link href="/dashboard" className={item(true)} style={activeStyle}><LayoutGrid size={17} /> Projects</Link>
        <Link href="/community" className={item(false)}><Compass size={17} /> Explore</Link>
